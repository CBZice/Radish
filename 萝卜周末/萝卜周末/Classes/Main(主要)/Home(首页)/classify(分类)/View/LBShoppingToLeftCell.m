...
@implementation LBShoppingToLeftCell
...
//        //添加右边的文字
//        UILabel *detailsLabel=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(topLine.frame)+10, 10, (self.width-5-20), (self.height-20))];
...
//        //添加图片的视图
//        UIImageView *pictureImageView=[[UIImageView alloc]initWithFrame:CGRectMake(middleLineW,imageViewY ,imageViewW ,imageViewH )];
...
//        //添加中间的线
//        UIView *middleLine=[[UIView alloc]initWithFrame:CGRectMake((CGRectGetMaxX(pictureImageView.frame)), (self.height-2)/2, middleLineW, 2)];
//        [self addSubview:middleLine];
//        self.middleLine=middleLine;
//        //添加addressImageView
//        UIImageView *addressImageView=[[UIImageView alloc]initWithFrame:CGRectMake(10,CGRectGetMaxY(pictureImageView.frame) , 20, imageViewY)];
...
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    LBShoppingToLeftCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIDLeft];
    if (cell == nil) {
        cell = [[LBShoppingToLeftCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIDLeft];
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.buttomLine=bottomLine;
        //添加右边的文字
        UILabel *detailsLabel=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(topLine.frame)+10, 10, (LBScreenWidth-5-20)/2, (self.height-20))];
        detailsLabel.numberOfLines=0;
        detailsLabel.font=[UIFont systemFontOfSize:17];
        detailsLabel.textAlignment=NSTextAlignmentLeft;
        detailsLabel.textColor=[UIColor blackColor];
...
//        CGFloat imageViewX=CGRectGetMaxX(circleView.frame)+2.5+middleLineW;
        ...
        self.middleLine=middleLine;
        //添加addressImageView
        UIImageView *addressImageView=[[UIImageView alloc]initWithFrame:CGRectMake(10,CGRectGetMaxY(pictureImageView.frame) , 20, 20)];
